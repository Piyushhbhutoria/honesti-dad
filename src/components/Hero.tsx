  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100">
      <div className="container mx-auto px-4 text-center max-w-4xl">
        <div className="mb-8">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-4 rounded-3xl w-fit mx-auto mb-8 shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
          >
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Easy to Share</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
            <div className="bg-red-50 p-3 rounded-xl w-fit mx-auto mb-4">
              <Heart className="h-6 w-6 text-red-500" />
            </div>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Honest & Safe</h3>
            <p className="text-gray-600">
